    ...
    return (
        <div className=" bg-hero p-10 md:p-20">
            <div className="flex flex-col lg:flex-row lg:flex justify-center p-10 rounded-lg">
                <form className="bg-white w-full md-:w-2/3 xl:w-1/2 p-6 rounded-lg drop-shadow-xl mt-auto mx-auto md:mx-4" onSubmit={handleFormSubmit}>
